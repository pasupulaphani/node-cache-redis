...
describe('redisConnectionPool', () => {
  ...
  describe('acquire', () => {
    ...
    test('conn timeout fail acquire connection', async () => {
      ...
      expect(localPool.acquire()).rejects.toThrowError('ResourceRequest timed out')
    })
  })
  ...
  describe('sendCommand', () => {
    ...
    test('reject when cmd failed', () => {
      expect(pool.sendCommand('keys')).rejects.toThrowError(/ERR wrong number of arguments for 'keys' command/)
    })
  })
})
