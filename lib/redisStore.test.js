...
describe('redisStore', () => {
  ...
  describe('del', () => {
    ...
    test(
      'return null deleting non-existing key',
  ...
  describe('expire', () => {
    ...
    test(
      'return null expiring non-existing key',
  ...
  describe('ttl', () => {
    ...
    test(
      'return null on ttl for a non-existing key',
  ...
  describe('deleteAll', () => {
    ...
    test('delete all the keys matches pattern', async () => {
      ...
      expect(store.keys()).resolves.toEqual(expect.not.arrayContaining(["key2"]));
    });
