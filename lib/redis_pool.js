    ...
    destroy: (client) => {
      return new Promise((resolve) => {
        ...
        try {
          // Flush when closing.
          client.end(true);
          debug("Client conn closed. Available count : %s. Pool size: %s", _pool.availableObjectsCount(), _pool.getPoolSize());
          resolve();
        } catch (err) {
